window.onload = function() {
  ...
  window.ui = SwaggerUIBundle({
	urls: [
	  ...
	  {url: "https://apidocs.soluvine.com/swagger.fxs.3_3_8_0.json", name: "FXS 3.3.8.0 and above"},
	  {url: "https://apidocs.soluvine.com/swagger.fxs.3_3_5_0.json", name: "FXS 3.3.5.0 to 3.3.7.0"},
	  {url: "https://apidocs.soluvine.com/swagger.fxs.3_2_6_0.json", name: "FXS 3.2.6.0 to 3.3.4.0"},
